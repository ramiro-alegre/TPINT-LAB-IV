...
<div class="conteiner__volver"><a href="Administrador.jsp">Volver</a></div>
...
<label for="materia">Materia</label> <select name="materia" id="materia">
...
<div class="conteiner__data">
<label for="semestre">Semestre</label> <select name="semestre" id="semestre">
...
<div class="conteiner__data">
<label for="anioCurso">Año</label> <input type="number" id="anioCurso" placeholder="2021" style="width:80px">
</div>

<div class="conteiner__data">
<label for="docente">Docente</label> <select name="semestre" id="semestre">
